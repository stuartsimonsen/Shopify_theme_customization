...
/* Added by Lucas M (Shopify Theme Support) on Feb 08, 2018 */
function equalHeights() {
  var max_height = 0,
      temp_height = 0;
 
  $('.text-column__wrapper').each(function() {
  ...
  if(max_height > 0) {
    $('.text-column__wrapper').css('height', max_height + 40); 
  }
...
/* Added by Ziyun on March 08, 2018 for variants and image be the same on shop and cart page */
$(document).ready(function() {
...
/* Added by Ziyun on March 23, 2018 for tick box (agree to terms) on cart page */
$(document).ready(function() {
